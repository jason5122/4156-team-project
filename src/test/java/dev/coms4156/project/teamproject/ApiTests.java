...
public class ApiTests {
  ...
  public void createClients() {
    ...
    RequestSpecification spec = new RequestSpecBuilder()
                                    .setBaseUri("http://34.85.143.68:8080/api/clientProfiles")
                                    .build();
  ...
  public void createAccountsForClient1() {
    ...
    RequestSpecification spec = new RequestSpecBuilder()
        .setBaseUri("http://34.85.143.68:8080/api/accountProfiles")
        .build();
  ...
  public void createListingsForClient1() {
    RequestSpecification spec = new RequestSpecBuilder()
        .setBaseUri("http://34.85.143.68:8080")
        .build();
  ...
  public void createRequestClient1Test() {
    RequestSpecification spec = new RequestSpecBuilder()
        .setBaseUri("http://34.85.143.68:8080/api/foodRequests")
        .build();
    Response response = given().spec(spec)
        .queryParam("clientId", client1Id)
        .queryParam("accountId", client1RecipientId)
