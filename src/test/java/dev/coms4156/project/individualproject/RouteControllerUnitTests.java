...
public class RouteControllerUnitTests {
  ...
  public void retrieveCoursesTest() {
    // For testing purposes, I added a 1004 course in ECON and IEOR departments in the data used by
    // this test class. Hence, we see from the data in resetDataFile() that 1004 is now a valid
    // course in COMS, ECON, and IEOR departments.
    int courseCode = 1004;
    String expectedResponse = "[\n"
        + "COMS: \n"
  ...
  public void setEnrollmentCountTest() {
    ...
    String expectedResponse = "Attribute was updated successfully if count <= course's capacity.";
