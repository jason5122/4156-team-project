...
public class DataInitializer implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    FoodListing listing1 = new FoodListing(foodDonationClient, provider1, "Sandwiches", 20,
        LocalDateTime.now().plusHours(5), 34.052f, -118.243f);
    FoodListing listing2 = new FoodListing(foodDonationClient, provider1, "Pasta", 15,
        LocalDateTime.now().plusHours(3), 34.052f, -118.243f);
    FoodListing listing3 = new FoodListing(foodDonationClient, provider1, "Salads", 10,
        LocalDateTime.now().plusHours(6), 34.052f, -118.243f);

    FoodListing listing4 = new FoodListing(foodDonationClient, provider2, "Fruit Basket", 8,
        LocalDateTime.now().plusHours(4), 40.7128f, -74.0060f);
    FoodListing listing5 = new FoodListing(foodDonationClient, provider2, "Cereal", 12,
