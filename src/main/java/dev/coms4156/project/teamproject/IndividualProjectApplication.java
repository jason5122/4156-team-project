...
public class IndividualProjectApplication implements CommandLineRunner {
    ...
    public void resetDataFile() {
        ...
        // data for econ dept
        Course econ1004 = new Course("Murat Yilmaz", "428 PUP", times[0], 110);
        econ1004.setEnrolledStudentCount(65);
        ...
        // data for ieor dept
        Course ieor1004 = new Course("Daniel Lacker", "501 NWC", times[0], 60);
        ieor1004.setEnrolledStudentCount(52);
        ...
        Course elen1202 = new Course("David G Vallancourt", "1205 MUDD", times[1], 120);
        elen1202.setEnrolledStudentCount(120);
    ...
    /**
     * This contains all the overheading teardown logic, it will mainly be focused on saving all
     * the created user data to a file, so it will be ready for the next setup.
     */
    @PreDestroy
