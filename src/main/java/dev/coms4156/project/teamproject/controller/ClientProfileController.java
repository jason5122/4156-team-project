 ...
 * 
 * This controller handles creating a new client profile and retrieving 
 * client profile details by client ID.
 */
@RestController
...
public class ClientProfileController {
     ...
     *
     * This endpoint is used to create a new client profile with a unique ID.
     * 
     ...
     * 
     * This endpoint fetches the details of a client profile using the provided client ID.
     * 
     * @param clientId the ID of the client profile to retrieve
     * @return a ResponseEntity containing the client profile details and HTTP status code 200,
     *         or an error message and HTTP status code 404 if the client ID is not found
     */
    @GetMapping("/get")
